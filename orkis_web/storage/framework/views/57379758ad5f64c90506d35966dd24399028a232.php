        ...
        <div class="row">
            <div class="d-flex flex-row justify-content-between bd-highlight col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-danger" href="<?php echo e(route('employees.index')); ?>">Вернуться назад</a>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /Users/daniilalekseev/Downloads/laba5/orkis_web/resources/views/employees/edit.blade.php ENDPATH**/ ?>