        ...
        <form method="post" action="/agreement" enctype="multipart/form-data">
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Дата создание соглашения</span>
                </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Страна посещения</span>
                </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Количество участников</span>
                </div>
                <input id='count' type="text" name='count' class="form-control" placeholder='1'>
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Дата начала поездки</span>
                </div>
                <input id='date_start' type="date" name='date_start' class="form-control">
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Дата окончания поездки</span>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex flex-row justify-content-between bd-highlight mb-3">
                        ...
                        <div style="margin-right: 10px;">
                            <button type="button" class="btn btn-warning" onclick="getNewCity()">+</button>
                        </div>
                        <div>
            ...
            <div class="md-3">
                ...
                <a href="/agreement" class="btn btn-danger">Отменить</a>
            </div>
        </form>
...
</script><?php /**PATH /Users/daniilalekseev/Downloads/laba5/orkis_web/resources/views/agreement/create.blade.php ENDPATH**/ ?>