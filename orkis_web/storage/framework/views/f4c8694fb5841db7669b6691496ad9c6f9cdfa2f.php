...
<body style="background-color:#96CEB4;">
    ...
    <div class="container p-5" style="margin-bottom: 100px;">
        ...
        <form method="post" action="/contract" enctype="multipart/form-data">
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Номер соглашения</span>
                </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Агент</span>
                </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Клиент</span>
                </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Страна</span>
                </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Город</span>
                </div>
            ...
            <div class="input-group mb-3 ">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Гостиницы</span>
                </div>
                <div class="d-flex flex-row justify-content-between bd-highlight mb-3">
                    ...
                    <div style="margin-right: 10px;">
                        <button type="button" class="btn btn-warning" onclick="getNewHotel()">+</button>
                    </div>
                    <div>
                        <button type="button" class="btn btn-warning" onclick="SortStraight()">По алфавиту</button>
                    </div>
                </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Вид номера</span>
                </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Начало поездки</span>
                </div>
                <input type="date" value="" name="start_trip" id="start_trip" class="form-control">
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Конец поездки</span>
                </div>
                <input type="date" value="" name="end_trip" id="end_trip" class="form-control">
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Участники</span>
                </div></br>
                <div class="d-flex flex-row justify-content-between bd-highlight mb-3">
                    ...
                    <button type="button" class="btn btn-warning" onclick="getNewParticipants()">+</button>
                </div>
                <div class="input-group mb-3 card" style='background-color: rgb(234, 237, 240);'>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="">Стоимость</span>
                </div>
            ...
            <div class="md-3">
                ...
                <a href="/contract" class="btn btn-danger">Отменить</a>
            </div>
        </form>
