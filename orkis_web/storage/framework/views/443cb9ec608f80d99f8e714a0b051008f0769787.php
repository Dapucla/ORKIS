...
<div class="d-flex flex-row justify-content-between">
    <div>
        <h2>Соглашения без договора</h2>
    </div>
    <div class="d-flex justify-content-end" style="align-self: center;"><a href="agreement/create" class="btn btn-warning mb-2">Создать соглашение</a></div>
</div>
...
<div class="d-flex flex-column bd-highlight mb-3 align-items-center">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/daniilalekseev/Downloads/laba5/orkis_web/resources/views/agreement/index.blade.php ENDPATH**/ ?>