...
<div class="d-flex flex-row justify-content-between">
    <div>
        <h2>Оплаченные договора</h2>
    </div>
    <div class="d-flex justify-content-end" style="align-self: center;"><a href="payment/create" class="btn btn-warning mb-2">Создать новый платеж</a></div>
</div>
...
<title>Платежи</title>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/daniilalekseev/Downloads/laba5/orkis_web/resources/views//payment/index.blade.php ENDPATH**/ ?>